...
declare const ProductListingSchema: z.ZodObject<{
    ...
    created_at: z.ZodNumber;
    content: z.ZodString;
    tags: z.ZodEffects<z.ZodArray<z.ZodUnion<[z.ZodTuple<[z.ZodLiteral<"d">, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"title">, z.ZodString], null>, z.ZodUnion<[z.ZodTuple<[z.ZodLiteral<"price">, z.ZodString, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"price">, z.ZodString, z.ZodString, z.ZodOptional<z.ZodEnum<["H", "D", "W", "M", "Y"]>>], null>]>, z.ZodTuple<[z.ZodLiteral<"type">, z.ZodEnum<["simple", "variable", "variation"]>, z.ZodEnum<["digital", "physical"]>], null>, z.ZodTuple<[z.ZodLiteral<"visibility">, z.ZodEnum<["hidden", "on-sale", "pre-order"]>], null>, z.ZodTuple<[z.ZodLiteral<"stock">, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"summary">, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"spec">, z.ZodString, z.ZodString], null>, z.ZodUnion<[z.ZodTuple<[z.ZodLiteral<"image">, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"image">, z.ZodString, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"image">, z.ZodString, z.ZodString, z.ZodString], null>]>, z.ZodTuple<[z.ZodLiteral<"weight">, z.ZodString, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"dim">, z.ZodString, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"location">, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"g">, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"t">, z.ZodString], null>, z.ZodTuple<[z.ZodLiteral<"a">, z.ZodEffects<z.ZodString, string, string>], null>, z.ZodUnion<[z.ZodTuple<[z.ZodLiteral<"shipping_option">, z.ZodEffects<z.ZodString, string, string>], null>, z.ZodTuple<[z.ZodLiteral<"shipping_option">, z.ZodEffects<z.ZodString, string, string>, z.ZodString], null>]>]>, "many">, (["d", string] | ["title", string] | ["a", string] | ["image", string] | ["summary", string] | ["location", string] | ["g", string] | ["shipping_option", string] | ["price", string, string] | ["price", string, string, "H" | "D" | "W" | "M" | "Y" | undefined] | ["image", string, string] | ["image", string, string, string] | ["shipping_option", string, string] | ["type", "simple" | "variable" | "variation", "digital" | "physical"] | ["visibility", "hidden" | "on-sale" | "pre-order"] | ["stock", string] | ["spec", string, string] | ["weight", string, string] | ["dim", string, string] | ["t", string])[], (["d", string] | ["title", string] | ["a", string] | ["image", string] | ["summary", string] | ["location", string] | ["g", string] | ["shipping_option", string] | ["price", string, string] | ["price", string, string, "H" | "D" | "W" | "M" | "Y" | undefined] | ["image", string, string] | ["image", string, string, string] | ["shipping_option", string, string] | ["type", "simple" | "variable" | "variation", "digital" | "physical"] | ["visibility", "hidden" | "on-sale" | "pre-order"] | ["stock", string] | ["spec", string, string] | ["weight", string, string] | ["dim", string, string] | ["t", string])[]>;
}, "strip", z.ZodTypeAny, {
    kind: 30402;
    tags: (["d", string] | ["title", string] | ["a", string] | ["image", string] | ["summary", string] | ["location", string] | ["g", string] | ["shipping_option", string] | ["price", string, string] | ["price", string, string, "H" | "D" | "W" | "M" | "Y" | undefined] | ["image", string, string] | ["image", string, string, string] | ["shipping_option", string, string] | ["type", "simple" | "variable" | "variation", "digital" | "physical"] | ["visibility", "hidden" | "on-sale" | "pre-order"] | ["stock", string] | ["spec", string, string] | ["weight", string, string] | ["dim", string, string] | ["t", string])[];
    content: string;
    created_at: number;
}, {
    kind: 30402;
