import { z } from "zod";
import { addressableFormat, geohash } from "./commonSchemas";
...
// Optional Tags
const CollectionImageTagSchema = z.tuple([
    z.literal("image"),
    z.string().url()
]);

const CollectionSummaryTagSchema = z.tuple([
    z.literal("summary"),
    z.string()
]);

const CollectionLocationTagSchema = z.tuple([
    z.literal("location"),
    z.string()
]);

const CollectionGeohashTagSchema = z.tuple([
    z.literal("g"),
    geohash
]);
